...
namespace EFCoreDemo.Migrations
{
    ...
    [Migration("20191212022612_AddColumnDateModified")]
    partial class AddColumnDateModified
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreDemo.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreDemo.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreDemo.Models.CourseInstructor", b =>
                {
                    ...
                    b.HasOne("EFCoreDemo.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("EFCoreDemo.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("EFCoreDemo.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("EFCoreDemo.Models.OfficeAssignment", b =>
                {
                    b.HasOne("EFCoreDemo.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("EFCoreDemo.Models.OfficeAssignment", "InstructorId")
